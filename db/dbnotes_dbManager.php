...
function getConnection() {
	...
	global $db_notes_db_Url, $db_notes_db_User, $db_notes_db_Pass, $db_notes_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_notes_db_Url.";dbname=".$db_notes_db_DbName, $db_notes_db_User, $db_notes_db_Pass);
